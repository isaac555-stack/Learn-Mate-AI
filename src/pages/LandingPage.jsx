...
// Create a "Bare Bones" or specific theme just for this component
export const landingTheme = createTheme({
  palette: {
    // You can leave this empty or define only what you need
  },
  typography: {
    fontFamily: "Inter, sans-serif", // Hardcode the font here
  },

  components: {
    // This part explicitly tells MUI components how to behave ONLY here
    MuiButton: {
      styleOverrides: {
        root: {
          borderRadius: "10px",
      ...
      styleOverrides: {
        root: {
          "& .MuiOutlinedInput-root": {
            backgroundColor: "#FFF",
            borderRadius: "10px",
            color: "#000", // Keep text black inside the white input
                      ...
                      >
                        ...
                        >
                          ...
                          <Box>
                            ...
                            >
                              We sent a magic link to <b>{email}</b>. Click it
            ...
            <Grid container spacing={4} alignItems="center">
              <Grid size={{ xs: 12, md: 5 }}>
                ...
                <Typography sx={{ color: alpha("#FFF", 0.6), mb: 4 }}>
                  Join thousands of Nigerian students who are turning their
                  messy notebooks into high-score reality.
                </Typography>
              </Grid>
          ...
          <Box sx={{ borderTop: `1px solid ${alpha("#FFF", 0.1)}` }}>
            {[
              ...
              >
                <AccordionSummary
                  expandIcon={
                    <ExpandMore sx={{ color: ACCENT, fontSize: 30 }} />
                  }
                  sx={{ px: 0 }}
                >
                  <Typography
